package com.microservice.gateway.apiGateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceRoutes() {
        System.out.println("here in api gateway routes order product_service of route /api/product");
    ...
    public RouterFunction<ServerResponse> orderServiceRoutes() {
        System.out.println("here in api gateway routes order of order_service route /api/order");
...
//        System.out.println("here in api gateway routes inventory");
    ...
    public RouterFunction<ServerResponse> fallbackRoute() {
        return GatewayRouterFunctions.route("fallbackRoute")
                .GET("/fallbackRoute",
                        request -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE).body("Service not available"))
                .build();
    }
